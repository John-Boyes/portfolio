    ...
    <div className='py-5 text-center'>
      ...
      <p>
        <div class="flex flex-wrap justify-center p-2 gap-4">
          <a href='https://www.facebook.com/john.m.boyes' target="_blank">
          ...
          <a href='https://www.instagram.com/johnboyes.dev' target="_blank">
          ...
          <a href='https://www.linkedin.com/in/john-boyes-9258a652/' target='_blank'>
          ...
          <a href='https://www.youtube.com/channel/UCsrLFCXWbkioeStbXK8t1mQ' target='_blank'>
          ...
          <a href='https://github.com/John-Boyes' target='_blank'>
          ...
          <a href='https://open.spotify.com/show/5bhUys8UthVfUXZLgOZX7Q' target='_blank'>
            <button class="bg-gray-700 p-2 font-semibold text-green-500 inline-flex items-center space-x-2 rounded">
