              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    ...
                    <a
                        key='Charity'
                        href='https://www.transplantalliance.org'
                        target='_blank'
                        className='text-gray-300 rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white'>
                            Charity
                        </a>
                    ...
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right 
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          ...
                          target="_blank"
                          style={{display: "flex"}}
                          className={classNames(active ? 'bg-gray-100' : '', 'block px-4 pt-4 pb-2 text-sm ')}
                          >
